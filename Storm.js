...
if (rfm.r(0x20)!=0x00) throw new Error("RFK69 not found in 0x1F");
  console.log("Register One Cleared");
rfm.w(0x22,0x00);
console.log("Register Two Set");
if (rfm.r(0x22)!=0x00) throw new Error("RFK69 not found in 0x2F");
...
RFK69.prototype.r = function(a) {
  console.log(this.spi.send([a&0x01,0], this.cs));  //  was 0x7f
  return this.spi.send([a&0x01,0], this.cs)[1];     //  was 0x7f
};
...
connect = function(spi,options,callback) {
...
function onInit() {
  SPI1.setup({mosi:D6,miso:D7,sck:D8});
  console.log("SPI1.send");
  console.log(SPI1.send);
  //rfm = require("https://github.com/rasksigr/rask_r1/blob/master/rfm69-96.js");
    connect(SPI1, {cs:D9, rst:D10, freq:915}, function() {
...
function onInit() {
  SPI1.setup({mosi:D6,miso:D7,sck:D8});
 // rfm = require("https://raw.githubusercontent.com/rasksigr/rask_r1/master/rfm69-96.js");
  //  rfm.connect(SPI1, {cs:D9, rst:D10, freq:434}, function() {
...
//https://github.com/rasksigr/rask_r1/blob/master/rfm69-96.js
